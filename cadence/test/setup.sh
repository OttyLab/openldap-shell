...
flow transactions send ./transactions/create_dit.cdc --signer admin "dc=example,dc=com"
...
flow transactions send ./transactions/create_dit.cdc --signer org0 "ou=org0,dc=example,dc=com"
...
flow transactions send ./transactions/create_dit.cdc --signer org1 "ou=org1,dc=example,dc=com"
...
flow transactions send ./transactions/create_dit.cdc --signer user0 "cn=taro.yamada,ou=person,dc=example,dc=com"
...
flow transactions send ./transactions/create_dit.cdc --signer user1 "cn=jiro.sato,ou=person,dc=example,dc=com"
